...
#
# Process YAML template files to replace image variables and runtimeClassName
...
export BUSYBOX_IMAGE NGINX_IMAGE AGHOST_IMAGE TEST_IMAGE_1 TEST_IMAGE_2 KUASAR_RUNTIME_CLASS

# Use envsubst to replace variables in the YAML file
# This will replace ${BUSYBOX_IMAGE}, ${NGINX_IMAGE}, ${KUASAR_RUNTIME_CLASS}, etc. with their values
