    ...
    C: Container + Sync + Send + 'static,
{
    ...
    async fn create(
        ...
        let span = info_span!("sandbox.task.rpc.create", task_id = %req.id);
        async {
